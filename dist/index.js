...
__export(index_exports, {
  ...
  Header: () => Header,
  useEventsCalendar: () => useEventsCalendar
});
...
var getDayjs = (rawDate, timeString) => {
  ...
  return (0, import_dayjs.default)(`${rawDate.format("DD-MMM-YYYY")} ${formatted}`);
};
function parseRawEvents(events) {
  return events.filter((event) => event.start || event.end).map((event, index) => {
    var _a, _b;
    let dayjsStart = event.start ? (0, import_dayjs.default)(event.start) : (0, import_dayjs.default)(event.end);
    if (event.startTime) {
      dayjsStart = getDayjs(dayjsStart, event.startTime);
    }
    let dayjsEnd = event.end ? (0, import_dayjs.default)(event.end) : dayjsStart;
...
var EMPTY_EVENT = {
  ...
  title: "Untitled",
  groups: [],
  start: (0, import_dayjs2.default)(),
  end: (0, import_dayjs2.default)(),
  startTime: void 0,
  endTime: void 0,
  isActive: false,
  isAllDay: true,
...
function useCalendarEvent({
  ...
  var _a;
  const [contextIsOpen, setContextIsOpen] = (0, import_react2.useState)(false);
  ...
  const { refs, floatingStyles, context } = (0, import_react3.useFloating)({
    ...
    middleware: [
      (0, import_react3.offset)({ mainAxis: 5, alignmentAxis: 4 }),
  ...
  const { getFloatingProps } = (0, import_react3.useInteractions)([dismiss]);
...
function useEventsCalendar({
  isInitialised = false,
  initialDate = (0, import_dayjs3.default)(),
  initialView = "month",
  closeOnClickOutside = true
} = {}) {
  const [activeDate, setActiveDate] = (0, import_react4.useState)((0, import_dayjs3.default)(initialDate));
  const [view, setView] = (0, import_react4.useState)(initialView);
  const [state, dispatch] = (0, import_react4.useReducer)(reducer, DEFAULT_STATE);
...
function TimeEvent({ event, isCompact }) {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { className: `${TimeEvent_default.timeContainer}`, "data-sm": isCompact, style: borderStyle, children: [
    /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { className: `${TimeEvent_default.timeDot}`, style: colorStyles }),
    /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { className: `${TimeEvent_default.timeText}`, children: start.format("h:mma") }),
    /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { className: `${TimeEvent_default.timeLabel}`, children: title })
  ] });
}
...
function AllDayEvent({ date, event, minMaxDatesInView, isCompact, isInOverflow }) {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("div", { className: AllDayEvent_default.container, style: __spreadProps(__spreadValues({}, colorstyles), { clipPath }), children: /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("div", { className: AllDayEvent_default.content, "data-sm": isCompact, children: /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("span", { className: AllDayEvent_default.text, "data-arrows": overflowArrows, children: event.title }) }) });
}
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)(import_jsx_runtime3.Fragment, { children: [
    /* @__PURE__ */ (0, import_jsx_runtime3.jsx)(
      "div",
      {
        ...
        ref: eventRef,
        style: styles,
        children: isMonthView ? !event.isAllDay ? /* @__PURE__ */ (0, import_jsx_runtime3.jsx)(TimeEvent, { event, isCompact: compact }) : /* @__PURE__ */ (0, import_jsx_runtime3.jsx)(
          AllDayEvent,
          {
            date,
            event,
        ...
        ) : /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)("div", { className: Event_default.itemLabelWrapper, "data-short": isShort, children: [
          /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("span", { style: isShort ? void 0 : { width: "100%" }, children: event.title }),
          /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("span", { className: Event_default.timeText, children: getTimeLabel(event, timeDuration) })
        ] })
      }
    ),
    contextIsOpen && /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("div", __spreadProps(__spreadValues({ ref: refs.setFloating, style: __spreadProps(__spreadValues({}, floatingStyles), { zIndex: 2 }) }, getFloatingProps()), { children: renderContextMenu && renderContextMenu({ event, closeContextMenu, onClose, openPopover }) }))
  ] });
}
...
function useBindPopover({ anchor }) {
  const preventViewportOverflow = {
    ...
    async fn(state) {
      var _a;
      const overflow = await (0, import_react_dom.detectOverflow)(state);
  ...
  const { refs, floatingStyles } = (0, import_react_dom.useFloating)({
    elements: {
      reference: anchor
    },
    placement: "bottom",
    ...
    middleware: [
      ...
      (0, import_react_dom.offset)(8),
      (0, import_react_dom.autoPlacement)({
        crossAxis: true,
        padding
      }),
...
function PopoverContent({ anchor, zIndex, colorScheme, children }) {
  const styles = (0, import_react6.useRef)({});
  ...
  return (0, import_react_dom2.createPortal)(
    /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(
      "div",
      {
        ...
        children: /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("div", { onClick: (e) => e.stopPropagation(), children })
      }
    ),
    document.body
  );
...
function EventsCalendarPopover({ anchor, colorScheme, isOpen, zIndex = 1, children }) {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime5.jsx)(PopoverContent, { anchor, zIndex, colorScheme, children });
}
...
function ShowMoreText({ date, dispatch, isCompact, numOverflowEvents, state }) {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime6.jsxs)(
    "div",
    {
      ...
      ref,
      children: [
        /* @__PURE__ */ (0, import_jsx_runtime6.jsx)("span", { className: `${ShowMoreText_default.label} ${ShowMoreText_default.smOnly}`, children: `+${numOverflowEvents}` }),
        /* @__PURE__ */ (0, import_jsx_runtime6.jsxs)("span", { className: `${ShowMoreText_default.label} ${ShowMoreText_default.lgOnly}`, children: [
          numOverflowEvents,
          " more"
        ] })
      ]
...
function CellHeader({ dayRecord, dispatch, isCompact, numOverflowEvents, state }) {
  ...
  const isToday = date.isSame((0, import_dayjs4.default)(), "day");
  const textColour = isToday ? "white" : isCurrentMonth ? "dark" : "dim";
  return /* @__PURE__ */ (0, import_jsx_runtime7.jsxs)("div", { className: CellHeader_default.cellHeader, children: [
    /* @__PURE__ */ (0, import_jsx_runtime7.jsx)("div", { className: CellHeader_default.dateContainer, "data-today": isToday, children: /* @__PURE__ */ (0, import_jsx_runtime7.jsx)("span", { className: CellHeader_default.dateLabel, "data-color": textColour, "data-sm": isCompact, children: date.date() }) }),
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime8.jsxs)(import_jsx_runtime8.Fragment, { children: [
    /* @__PURE__ */ (0, import_jsx_runtime8.jsxs)(
      "div",
      {
        ...
        children: [
          !isInWeekHeader && !isInDayHeader && /* @__PURE__ */ (0, import_jsx_runtime8.jsx)(
            CellHeader,
            {
              state,
              dispatch,
          ...
          /* @__PURE__ */ (0, import_jsx_runtime8.jsx)("div", { className: EventCell_default.cellContent, "data-week": isInWeekHeader || isInDayHeader, children: showOverflowButton && /* @__PURE__ */ (0, import_jsx_runtime8.jsx)(
            ShowMoreText,
            {
              date,
              state,
    ...
    visibleEvents.map((event) => /* @__PURE__ */ (0, import_jsx_runtime8.jsx)(
      Event,
      {
        date,
        view: "month",
...
function CircularLoader({ visible }) {
  if (!visible) return;
  return /* @__PURE__ */ (0, import_jsx_runtime9.jsx)("div", { className: CircularLoader_default.loaderWrapper, children: /* @__PURE__ */ (0, import_jsx_runtime9.jsx)("span", { className: CircularLoader_default.loader }) });
}
...
function MantineThemeProvider({
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime13.jsx)(MantineThemeContext.Provider, { value: mergedTheme, children });
}
...
function useRandomClassName() {
  const id = (0, import_react27.useId)().replace(/:/g, "");
  return `__m__-${id}`;
}
...
// node_modules/@mantine/core/esm/core/Box/Box.mjs
var _Box = (0, import_react28.forwardRef)(
  (_a, ref) => {
    var _b = _a, {
      component,
      style,
    ...
    return /* @__PURE__ */ (0, import_jsx_runtime28.jsxs)(import_jsx_runtime28.Fragment, { children: [
      ...
      typeof renderRoot === "function" ? renderRoot(props) : /* @__PURE__ */ (0, import_jsx_runtime28.jsx)(Element, __spreadValues({}, props))
    ] });
  }
);
...
function factory(ui) {
  const Component = (0, import_react29.forwardRef)(ui);
  Component.extend = identity;
  Component.withProps = (fixedProps) => {
    const Extended = (0, import_react29.forwardRef)((props, ref) => /* @__PURE__ */ (0, import_jsx_runtime29.jsx)(Component, __spreadProps(__spreadValues(__spreadValues({}, fixedProps), props), { ref })));
...
var Divider = factory((_props, ref) => {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime30.jsx)(
    ...
    __spreadProps(__spreadValues(__spreadValues({
      ...
      role: "separator",
      children: label && /* @__PURE__ */ (0, import_jsx_runtime30.jsx)(Box, __spreadProps(__spreadValues({ component: "span", mod: { position: labelPosition } }, getStyles("label")), { children: label }))
    })
  );
});
...
function Controls({ hideViewToggle, views, setView, view, children }) {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime32.jsxs)("div", { className: Header_default.controls, children: [
    !hideViewToggle && viewsToDisplay.length > 1 && /* @__PURE__ */ (0, import_jsx_runtime32.jsx)("div", { className: Header_default.buttonGroup, children: viewsToDisplay.map((viewLabel) => /* @__PURE__ */ (0, import_jsx_runtime32.jsx)(HeaderButton, { isGroupButton: true, active: view === viewLabel, onClick: () => setView(viewLabel), children: viewLabel }, viewLabel)) }),
    children
  ] });
}
...
function IconChevronLeft({ size = "24", stroke = "2" }) {
  return /* @__PURE__ */ (0, import_jsx_runtime33.jsxs)(
    "svg",
    {
      ...
      children: [
        /* @__PURE__ */ (0, import_jsx_runtime33.jsx)("path", { stroke: "none", d: "M0 0h24v24H0z", fill: "none" }),
        /* @__PURE__ */ (0, import_jsx_runtime33.jsx)("path", { d: "M15 6l-6 6l6 6" })
      ]
    }
  );
}
...
function IconChevronRight({ size = "24", stroke = "2" }) {
  return /* @__PURE__ */ (0, import_jsx_runtime34.jsxs)(
    "svg",
    {
      ...
      children: [
        /* @__PURE__ */ (0, import_jsx_runtime34.jsx)("path", { stroke: "none", d: "M0 0h24v24H0z", fill: "none" }),
        /* @__PURE__ */ (0, import_jsx_runtime34.jsx)("path", { d: "M9 6l6 6l-6 6" })
      ]
    }
  );
}
...
function Navigation({ activeDate, setActiveDate, view }) {
  const handleToday = () => setActiveDate((0, import_dayjs5.default)());
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime35.jsxs)("div", { className: Header_default.navigation, children: [
    /* @__PURE__ */ (0, import_jsx_runtime35.jsx)(HeaderButton, { variant: "outline", onClick: handleToday, children: "Today" }),
    /* @__PURE__ */ (0, import_jsx_runtime35.jsxs)("div", { className: Header_default.actions, children: [
      /* @__PURE__ */ (0, import_jsx_runtime35.jsx)(HeaderButton, { variant: "subtle", onClick: () => handlePrev(view), children: /* @__PURE__ */ (0, import_jsx_runtime35.jsx)(IconChevronLeft, { size: "1.5rem" }) }),
      /* @__PURE__ */ (0, import_jsx_runtime35.jsx)(HeaderButton, { variant: "subtle", onClick: () => handleNext(view), children: /* @__PURE__ */ (0, import_jsx_runtime35.jsx)(IconChevronRight, { size: "1.5rem" }) })
    ] }),
    /* @__PURE__ */ (0, import_jsx_runtime35.jsx)("span", { className: Header_default.date, children: getHeaderTitle(activeDate, view) })
  ] });
}
...
function Header({
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime36.jsxs)(import_jsx_runtime36.Fragment, { children: [
    /* @__PURE__ */ (0, import_jsx_runtime36.jsxs)("div", { className: Header_default.header, onClick, children: [
      /* @__PURE__ */ (0, import_jsx_runtime36.jsx)(Navigation, { activeDate, setActiveDate, view }),
      /* @__PURE__ */ (0, import_jsx_runtime36.jsx)(Controls, { hideViewToggle, views, setView, view, children: customControls })
    ] }),
...
var NOW_IN_MINUTES = (0, import_dayjs6.default)().diff((0, import_dayjs6.default)().startOf("day"), "m");
...
function HoursColumn() {
  return /* @__PURE__ */ (0, import_jsx_runtime37.jsx)("div", { className: HoursColumn_default.hoursColumn, children: HOURS.map((hour) => /* @__PURE__ */ (0, import_jsx_runtime37.jsx)("div", { className: HoursColumn_default.hour, children: /* @__PURE__ */ (0, import_jsx_runtime37.jsx)("span", { className: HoursColumn_default.hourLabel, children: hour }) }, hour)) });
}
...
var NOW = (0, import_dayjs7.default)();
function TimeIndicator({ activeDate, isDayView }) {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime38.jsxs)("div", { className: TimeIndicator_default.wrapper, style: { gridColumn, gridRow }, children: [
    /* @__PURE__ */ (0, import_jsx_runtime38.jsx)("div", { className: TimeIndicator_default.dot }),
    /* @__PURE__ */ (0, import_jsx_runtime38.jsx)("div", { className: TimeIndicator_default.line })
  ] });
}
...
function TimeBackground({
  ...
  const openPopover = () => dispatch({ type: "open_popover" });
  const reset = () => dispatch({ type: "reset_calendar" });
  return /* @__PURE__ */ (0, import_jsx_runtime39.jsx)(import_jsx_runtime39.Fragment, { children: daysArray.map(
    (day) => hoursArray.map(
...
function TimeViewHeader({
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime40.jsx)("div", { className: TimeViewHeader_default.headerRow, "data-isweekview": view === "week", onMouseLeave: handleStopDrag, children: weekDatesArray.map((dayRecord, dayIndex) => {
    const { date } = dayRecord;
    const withHeaderBorder = view === "week" || filteredEvents.length > 0;
    return /* @__PURE__ */ (0, import_jsx_runtime40.jsxs)("div", { className: TimeViewHeader_default.headerCell, "data-border": withHeaderBorder, children: [
      view === "week" && /* @__PURE__ */ (0, import_jsx_runtime40.jsx)("div", { className: TimeViewHeader_default.headerLabel, "data-today": date.isSame((0, import_dayjs8.default)(), "day"), onMouseEnter: handleStopDrag, children: `${date.format("ddd")} ${date.format("DD")}` }),
...
function TimeView({
  ...
  const weekDatesArray = (0, import_react32.useMemo)(() => getWeekDates(activeDate, view), [activeDate, view]);
  const minMaxDatesInView = {
    first: isDayView ? activeDate : weekDatesArray[0].date,
    last: isDayView ? activeDate : weekDatesArray[6].date
  };
  const dayMap = (0, import_react32.useMemo)(() => getEventsByDayMap(weekDatesArray, timeEvents), [timeEvents, weekDatesArray]);
  return /* @__PURE__ */ (0, import_jsx_runtime41.jsxs)("div", { className: TimeView_default.timeView, children: [
    ...
    /* @__PURE__ */ (0, import_jsx_runtime41.jsx)("div", { ref: viewportRef, className: TimeView_default.scrollWrapper, children: /* @__PURE__ */ (0, import_jsx_runtime41.jsxs)("div", { className: TimeView_default.gridWrapper, children: [
      /* @__PURE__ */ (0, import_jsx_runtime41.jsx)(HoursColumn, {}),
      /* @__PURE__ */ (0, import_jsx_runtime41.jsxs)(
        "div",
        {
          ...
          children: [
            ...
            /* @__PURE__ */ (0, import_jsx_runtime41.jsx)(TimeIndicator, { activeDate, isDayView }),
            weekDatesArray.map(({ date }, dayIndex) => {
              ...
              return orderedEvents.map((event) => /* @__PURE__ */ (0, import_jsx_runtime41.jsx)(
                Event,
                {
                  date,
                  dispatch,
...
function generateYearDates(activeDate, events) {
  ...
  MONTHS.forEach((month, i) => {
    ...
    const dateArray = Array.from({ length: DAYS_IN_FULL_MONTH }, (_, i2) => {
      ...
      const isToday = date.isSame((0, import_dayjs9.default)(), "day");
...
function YearView({ activeDate, dispatch, events, state }) {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime43.jsx)("div", { className: YearView_default.scrollWrapper, children: /* @__PURE__ */ (0, import_jsx_runtime43.jsx)("div", { className: YearView_default.yearView, onMouseDown: handleMouseDown, children: MONTHS.map((month) => {
    return /* @__PURE__ */ (0, import_jsx_runtime43.jsxs)("div", { className: YearView_default.month, children: [
      /* @__PURE__ */ (0, import_jsx_runtime43.jsx)("div", { className: YearView_default.monthLabel, children: month }),
      /* @__PURE__ */ (0, import_jsx_runtime43.jsxs)("div", { className: YearView_default.monthDates, children: [
        DAY_LABELS_SHORT.map((day, i) => /* @__PURE__ */ (0, import_jsx_runtime43.jsx)("div", { className: YearView_default.monthHeaderDay, children: day }, `${month}-${i}`)),
        yearDates[month].map(({ date, isToday, isCurrentMonth, isActive }, i) => /* @__PURE__ */ (0, import_jsx_runtime43.jsx)(
          MonthDate,
          {
            date,
            handleClick,
...
function MonthHeader({ isCompact }) {
  return /* @__PURE__ */ (0, import_jsx_runtime44.jsx)("div", { className: MonthHeader_default.monthHeader, "data-sm": isCompact, children: DAYS.map((day, i) => /* @__PURE__ */ (0, import_jsx_runtime44.jsx)("div", { className: MonthHeader_default.headerCell, children: day }, i)) });
}
...
function MonthView({
  ...
  const monthDates = (0, import_react34.useMemo)(() => getMonthDates(activeDate), [activeDate]);
  ...
  const weekMap = (0, import_react34.useMemo)(() => getEventsByWeekMap(monthDates.weeks, events), [events, monthDates.weeks]);
  return /* @__PURE__ */ (0, import_jsx_runtime45.jsxs)("div", { className: MonthView_default.monthView, children: [
    /* @__PURE__ */ (0, import_jsx_runtime45.jsx)(MonthHeader, { isCompact: compact }),
    /* @__PURE__ */ (0, import_jsx_runtime45.jsx)("div", { className: MonthView_default.grid, onMouseLeave: handleStopDrag, ref: gridRef, children: monthDates.weeks.map((week, weekIndex) => {
      const orderedEvents = gridHeight > 0 ? weekMap[weekIndex] : [];
      return /* @__PURE__ */ (0, import_jsx_runtime45.jsx)("div", { className: MonthView_default.row, children: week.map((dayRecord, dayIndex) => /* @__PURE__ */ (0, import_jsx_runtime45.jsx)(
        CellContainer,
        {
          EVENT_LIMIT: EVENT_LIMIT2,
          enableRescheduling,
...
var tryDate = (dateString) => dateString ? (0, import_dayjs10.default)(dateString) : void 0;
function OverflowCard({
  ...
  if (!date || !state.overflowAnchor) return /* @__PURE__ */ (0, import_jsx_runtime46.jsx)(import_jsx_runtime46.Fragment, {});
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime46.jsx)(
    EventsCalendarPopover,
    {
      ...
      colorScheme,
      children: /* @__PURE__ */ (0, import_jsx_runtime46.jsxs)("div", { className: OverflowCard_default.overflowCard, children: [
        /* @__PURE__ */ (0, import_jsx_runtime46.jsx)("span", { className: OverflowCard_default.label, children: date.format("dddd, MMMM D") }),
        !orderedEvents.length && /* @__PURE__ */ (0, import_jsx_runtime46.jsx)("div", { className: OverflowCard_default.empty, children: "No events scheduled for this date" }),
        /* @__PURE__ */ (0, import_jsx_runtime46.jsx)("div", { className: OverflowCard_default.eventsWrapper, children: orderedEvents.map((event) => /* @__PURE__ */ (0, import_jsx_runtime46.jsx)(
          Event,
          {
            view: "month",
            isInOverflow: true,
...
function EventsCalendar({
  ...
  const parsed = (0, import_react35.useMemo)(() => parseRawEvents(events), [events]);
  const calendarEvents = (0, import_react35.useMemo)(() => filterByView(parsed, activeDate, view), [parsed, activeDate, view]);
  ...
  const placeholderRef = (0, import_react35.useRef)(null);
  ...
  const renderCurrentView = () => {
    switch (view) {
      case "year":
        return /* @__PURE__ */ (0, import_jsx_runtime47.jsx)(YearView, __spreadValues({}, basicProps));
      case "month":
        return /* @__PURE__ */ (0, import_jsx_runtime47.jsx)(MonthView, __spreadValues({}, sharedViewProps));
      case "week":
      case "day":
        return /* @__PURE__ */ (0, import_jsx_runtime47.jsx)(TimeView, __spreadProps(__spreadValues({}, sharedViewProps), { view }));
      default:
        return null;
    }
  };
  return /* @__PURE__ */ (0, import_jsx_runtime47.jsxs)("div", { className: EventsCalendar_default.root, "data-ec-color-scheme": colorScheme, children: [
    noHeader ? null : /* @__PURE__ */ (0, import_jsx_runtime47.jsx)(Header, { view, setActiveDate, setView, activeDate, views }),
    /* @__PURE__ */ (0, import_jsx_runtime47.jsxs)("div", { className: EventsCalendar_default.calendar, "data-withheader": !noHeader, onClick: (e) => e.stopPropagation(), children: [
      /* @__PURE__ */ (0, import_jsx_runtime47.jsx)(CircularLoader, { visible: isFetching }),
      renderCurrentView(),
      renderPopover && eventAnchor && /* @__PURE__ */ (0, import_jsx_runtime47.jsx)(
        EventsCalendarPopover,
        {
