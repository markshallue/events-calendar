        ...
        <Group className={classes.heroContent}>
          <Stack className={classes.heroText}>
            <Title className={classes.mainTitle}>
              ...
              <Text
                ...
                inherit
                variant="gradient"
                gradient={{ from: 'indigo.5', to: 'grape.5', deg: 135 }}
              >
                Calendar Component
              </Text>{' '}
            ...
            <Text size="lg" c="dimmed">
              A flexible, responsive, and feature-packed calendar designed for modern React
              applications
            </Text>
            <Group mt="md">
              <Button
          ...
          <Box className={classes.calendarContainer}>
            <Paper
              withBorder
              radius="md"
              className={classes.demoCalendarWrapper}
              style={{ flexGrow: 1 }}
            >
              <LiveDemo />
            </Paper>
