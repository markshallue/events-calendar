...
import {
  calendarPropTypesCode,
  EventsCalendarObject,
  eventsObjectCode,
  useEventsCalendarCode,
} from './codeSnippets';
      ...
      <PageWrapper withTableOfContents>
        <Stack gap="xl">
          ...
          <Stack>
            ...
            <Text>
              With the <Code>useEventsCalendar</Code> hook, you can set the initial state of the
              calendar, as well as manage the calendar state externally. A common use-case is for
