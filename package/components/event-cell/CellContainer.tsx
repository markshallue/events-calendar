...
const getPlaceholderActiveState = (
...
export function CellContainer<T>({
  ...
  const showPlaceholder = getPlaceholderActiveState(
  ...
  return (
    <>
      ...
      >
        ...
        <div
          className="events-calendar-month-cell-content"
          data-week={isInWeekHeader || isInDayHeader}
        >
          {showOverflowButton && (
            <ShowMoreText
              date={date}
