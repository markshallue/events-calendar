...
import { Badge, Card, CloseButton, Divider, Group, ScrollArea, Stack, Text } from '@mantine/core';
import { EventActions } from '@/components';
import { DemoEvent, HandleSubmitArgs } from '@/types';
import { getDateTimeLabel, humanize } from '@/utils';
    ...
    <Card className={classes.DetailPopover} padding={0} withBorder>
      ...
      <div className={classes.DetailPopoverSection}>
        ...
        {event.content && event.content?.length > 0 && (
          <ScrollArea.Autosize mah={220} mt="0.5rem">
            <Stack gap="sm">
      ...
      {showToolbar && (
        <>
          <Divider />
          <Group px="md" py="xs" style={{ flexShrink: 0 }}>
